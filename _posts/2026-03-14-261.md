...
Developers should use Loom 1.15 and Gradle 9.3.0 (at the time of writing) to develop mods for Minecraft 26.1. Players should install the latest stable version of Fabric Loader (currently 0.18.4).
