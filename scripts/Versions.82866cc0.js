...
import { d as _e, b as de, a as be, k as he, l as ve } from "./Api.322fe952.js";
function se(o, t, p) {
  const f = o.slice();
  return f[9] = t[p], f;
}
...
function ye(o) {
  ...
  return re(
    ...
    c() {
      s.block.c(), t = k(), p = c("hr"), f = k(), _ = c("h2"), _.textContent = "Loom", d = k(), v = c("p"), v.innerHTML = "The recommended loom version is <strong>1.13-SNAPSHOT</strong>. This is usually defined near the top of your build.gradle file.";
    },
    m(i, m) {
