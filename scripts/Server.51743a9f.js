import { S as qe, i as Fe, s as Je, h as Me, e as i, c as g, u as Ue, r as Le, v as Se, d as k, f as re, t as I, a as b, g as H, j as s, n as F, w as Ge, o as _, m as oe, p as B, x as Te, q as se, k as ge, l as ae, y as ze, A as Ae } from "./index.3ed5914c.js";
import { d as De, b as Ee, c as ye } from "./Api.eb915771.js";
import Be from "./DownloadIcon.fd237c91.js";
function ke(n, e, r) {
  const o = n.slice();
  return o[11] = e[r], o;
}
...
function Oe(n) {
  let e, r, o, c, a, m, f, h, G, V, X, J, T, K, j, L, w, C, z, ie, ce, Q, O, fe, R, N, W, S, Y, ue, Z, _e, P, he, $, x, q, ee, me, te, de, A, pe, le, ve, M, ne, be, D = (
    /*data*/
    n[10].game
  ), d = [];
  ...
  return z = new Be({}), {
    c() {
      ...
      n[2] === void 0 && oe(() => (
        ...
        /*installerJarUrl*/
        n[3]
      ), _(e, "class", "download"), _(P, "class", "svelte-l8qzb7"), H(S, "margin-bottom", "15px"), _(A, "class", "svelte-l8qzb7"), H(q, "margin-bottom", "15px");
    },
    m(t, u) {
      ...
      B(
        ...
        n[2],
        !0
      ), s(e, L), s(e, w), s(w, C), Te(z, C, null), s(C, ie), s(e, ce), s(e, Q), s(Q, O), s(O, fe), g(t, R, u), g(t, N, u), g(t, W, u), g(t, S, u), s(S, Y), s(S, ue), s(S, Z), s(S, _e), s(S, P), s(P, he), s(P, $), g(t, x, u), g(t, q, u), s(q, ee), s(q, me), s(q, te), s(q, de), s(q, A), s(A, pe), s(A, le), s(A, ve), M = !0, ne || (be = [
        se(
          a,
          "change",
          /*select0_change_handler*/
