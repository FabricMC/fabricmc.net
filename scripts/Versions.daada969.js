...
function ce(l) {
  ...
  return Z(
    ...
    c() {
      o.block.c(), t = V(), i = b("h4"), i.textContent = "Loom", n = V(), c = b("p"), c.innerHTML = "The recommended loom version is <strong>1.3-SNAPSHOT</strong>. This is usually defined near the top of your build.gradle file.";
    },
    m(r, s) {
