...
function pe(o) {
  ...
  return W(
    ...
    c() {
      l.block.c(), e = T(), s = _("hr"), r = T(), n = _("h2"), n.textContent = "Loom", f = T(), d = _("p"), d.innerHTML = "The recommended loom version is <strong>1.17-SNAPSHOT</strong>. This is usually defined near the top of your build.gradle file.";
    },
    m(i, a) {
