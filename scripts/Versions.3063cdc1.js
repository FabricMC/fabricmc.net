...
import { c as te } from "./minecraft.d54608dc.js";
import { d as ne, b as oe, a as se, k as le, l as ie } from "./Api.fd2c0b6d.js";
function B(o, e, s) {
  const r = o.slice();
  return r[10] = e[s], r;
}
...
function pe(o) {
  ...
  return W(
    ...
    c() {
      l.block.c(), e = T(), s = _("hr"), r = T(), n = _("h2"), n.textContent = "Loom", f = T(), d = _("p"), d.innerHTML = "The recommended loom version is <strong>1.16-SNAPSHOT</strong>. This is usually defined near the top of your build.gradle file.";
    },
    m(i, a) {
